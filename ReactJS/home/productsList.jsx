...
const ProductList = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                // Filter products where is_deleted is not "true"
                const filteredProducts = response.data.filter(product => product.is_deleted !== 'True');
    ...
    return (
        <>
            <h1 className="text-3xl font-extrabold mb-4 text-gray-800">Produkte te Ndryshme</h1>
